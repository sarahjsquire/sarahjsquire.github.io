...
function stocktoids(){
	var newEpisode = "<h4>Self-updating, factoid generator collects market data and calculates nine facts of interest. The data is wrangled by PHP and MySql and the front end uses SocialClimber, a custom plug-in for generating custom social buttons, a modified version of <a class='external' href='//twitter.github.io/typeahead.js/'>typeahead.js</a>, and <a class='external' href='//handlebarsjs.com/'>handlebars.js</a>. Stocktoids has an admin site for editors to edit the list of included tickers, and hash changes allow for individual company pages to be displayed with stories. In addition to being a resource for readers, Stocktoids is a tool for reporters and editors to find interesting numbers for stories.</h4><iframe src='//projects.marketwatch.com/stocktoids?standalone=1' width='770' height='683' frameborder='0' marginwidth='0' marginheight='0' hspace='0' vspace='0' border='0' scrolling='yes' style='margin: 5px 0 0 0px; padding: 0px;'></iframe>";
	document.getElementById('changeImage').innerHTML = newEpisode;
}

function facebookipo(){
	var newEpisode = "<h4>Timeline, published on <a class='external' href='//projects.marketwatch.com/facebook-ipo-anniversary-timeline/#'>MarketWatch.com</a>, highlighting key events in Facebook's first year as a publicly traded company. I designed and developed the responsive, mobile-friendly page in a few days  using Highcharts.js and SocialClimber, my custom plug-in for social sharing buttons. In development, the text and media were easily editable as a JSON file and incorporated using a Handlebars.js template, and the page was later compiled for publishing</h4><iframe src='//projects.marketwatch.com/facebook-ipo-anniversary-timeline/?standalone=1#' width='770' height='683' frameborder='0' marginwidth='0' marginheight='0' hspace='0' vspace='0' border='0' scrolling='yes' style='margin: 5px 0 0 0px; padding: 0px;'></iframe>";
	document.getElementById('changeImage').innerHTML = newEpisode;
}

function slidestream(){
	var newEpisode = "<h4>Social slideshow tool built for <em>The Wall Street Journal</em>. Primarily built the <a class='external' href='//projects.wsj.com/slidestream/viewer/index.php?slug=ELECTION_STANDALONE&map=true'>responsive</a> front end to work crossbrowsers and platforms. Tool includes several options, e.g., a custom Google Map for images with geodata, an adjustable aspect ratio for the viewer and <a class='external' href='//online.wsj.com/article/SB10000872396390444405804577561282207481746.html'>panorama</a> setting. Helped develop the admin side built on Backbone.js.</h4><iframe src='//projects.wsj.com/slidestream/viewer/index.php?slug=OLYMPICSWSJ&map=true' width='770' height='683' frameborder='0' marginwidth='0' marginheight='0' hspace='0' vspace='0' border='0' scrolling='no' style='margin: 5px 0 0 0px; padding: 0px;'></iframe>";
	document.getElementById('changeImage').innerHTML = newEpisode;
}

function olysmiles(){
	var newEpisode = "<h4>Visual voting tool built for <em>The Wall Street Journal</em>. Responsive Application is built on a preexisting framework and admin tool for another poll adopted to extend to additional projects. Framework also used to redesign a <a class='external' href='//projects.wsj.com/quiz/how.php?uid=HOW120914&type=house'>Flash poll using JavaScript</a>. <a class='external' href='//projects.wsj.com/olympics2012/london-winning-faces/index.php?uid=medal_faces&type=olympics'>Vote: Winning Faces</a></h4><img src='images/olysmiles-before.png' width='750px' /><img src='images/olysmiles-after.png' width='750px' />";
	document.getElementById('changeImage').innerHTML = newEpisode;
}

function olystadium(){
	var newEpisode = "<h4>I built the presentation page for two graphics about the Olympic Stadium and Village. The video about the Olympic Stadium is linked to navigation steps using JW Player. <a class='external' href='//projects.wsj.com/olympics2012/olympic-park/'>Playing London's Games</a></h4><img src='images/olystadium.png' width='750px' /><img src='images/olyvillage.png' width='750px' />";
	document.getElementById('changeImage').innerHTML = newEpisode;
}

function mixingitup(){
	var newEpisode = "<h4>Investment poll for <em>The Wall Street Journal</em>'s monthly financial column Mixing It Up. Uses Highcharts.js to graph your answers against average of users. Submissions automatically reset every month. <a class='external' href='//online.wsj.com/article/SB10001424127887324307204578129034183630410.html#articleTabs%3Dinteractive'>How Does Your Allocation Compare?</a></h4><img src='images/MIU.png' width='750px' /><img src='images/MIU-submit.png' width='750px' />";
	document.getElementById('changeImage').innerHTML = newEpisode;
}
...
function photopage(){
	var newEpisode = "<h4><em>March 30, 2011</em> - Special package for photos of the year. Select photos are paired with a brief interview with the photographer, which I helped edit. Design and code done on deadline. <a class='external' href='//michigandaily.com/photostore-best2011'>Photos of the Year, 2010-2011</a></h4><img src='images/PhotosoftheYear.png' width='625px' />";
	document.getElementById('changeImage').innerHTML = newEpisode;
}
